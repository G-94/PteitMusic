...
public:
    ...
    void searchArtists(const QString& artist);
...
private slots:
    ...
    void onSearchByQueryFinished(QNetworkReply* reply);
    void onSearchByGenreFinished(QNetworkReply* reply);
    void onSearchArtistsFinished(QNetworkReply* reply);
    void onTracklistByArtistIdFinished(QNetworkReply* reply, bool isForPlay);
    void onArtistDataBySongIdFinished(QNetworkReply* reply);
